		...
		//	if( Vertices->size() > 3 )
			{
				...
				XMFLOAT3 Q11;
				Q11.x = Vertices[0][i1].Pos.x - Vertices[0][i0].Pos.x;
				Q11.y = Vertices[0][i1].Pos.y - Vertices[0][i0].Pos.y;
				Q11.z = Vertices[0][i1].Pos.z - Vertices[0][i0].Pos.z;
				XMVECTOR Q1 = XMVectorSet( Q11.x, Q11.y, Q11.z, 1.0 );


				XMFLOAT3 Q22;
				Q22.x = Vertices[0][i2].Pos.x - Vertices[0][i0].Pos.x;
				Q22.y = Vertices[0][i2].Pos.y - Vertices[0][i0].Pos.y;
				Q22.z = Vertices[0][i2].Pos.z - Vertices[0][i0].Pos.z;
				XMVECTOR Q2 = XMVectorSet( Q22.x, Q22.y, Q22.z, 1.0 );


				XMFLOAT2 u0 = Vertices[0][i0].Tex;
				XMFLOAT2 u1 = Vertices[0][i1].Tex;
				XMFLOAT2 u2 = Vertices[0][i2].Tex;
				...
				XMStoreFloat3( &Vertices[0][i0].Tangent, T );
				XMStoreFloat3( &Vertices[0][i1].Tangent, T );
				XMStoreFloat3( &Vertices[0][i2].Tangent, T );

				XMStoreFloat3( &Vertices[0][i0].BiNormal, B );
				XMStoreFloat3( &Vertices[0][i1].BiNormal, B );
				XMStoreFloat3( &Vertices[0][i2].BiNormal, B );
